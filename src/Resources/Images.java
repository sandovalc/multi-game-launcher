...
public class Images {
    ...
    public static BufferedImage[] galagaEnemyAlien;
    ...
    public Images() {
        ...
        galagaEnemyAlien = new BufferedImage[2];
        ...
        try {
            ...
            galagaEnemyAlien[0] = galagaSpriteSheet.crop(161,127,15, 16);
            galagaEnemyAlien[1] = galagaSpriteSheet.crop(185,128,15,15);
