...
public class EnemyAlien extends BaseEntity {
	...
	public EnemyAlien(int x, int y, int width, int height, Handler handler,int row, int col) {
		...
		idleAnimList[0] = Images.galagaEnemyAlien[0];
		idleAnimList[1] = Images.galagaEnemyAlien[1];
		idle = new Animation(512,idleAnimList);
		turn90Left = new Animation(128,Images.galagaPlayer);
		spawn();
		speed = 4;
